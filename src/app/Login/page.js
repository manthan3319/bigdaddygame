                    ...
                    <Tabs>
                        <div className='text-center mb-[50px]'>
                            <div className=''>
                                <TabList className="tablist_login flex flex-row justify-between">
                                    <Tab className="w-[50%] ">
                                        <h1 className='p-[5px] font-jakarta text-[15px] flex flex-col gap-[2px] items-center'> 
                                            <span>
                                                <Image src={mobileicon} width={30} height={30} alt="img" />
                                            </span> 
                                            <span>Log in with phone</span>
                                        </h1>
                                    </Tab>
                                    <Tab className="w-[50%]">
                                        <h1 className='p-[5px] font-jakarta text-[15px] lex flex-col gap-[2px] items-center'>
                                            <span className='flex justify-center gap-[3px]'>
                                                <Image src={emailicon} alt='img' width={30} height={30} /> 
                                                <Image src={usericon} alt='img' width={30} height={30} />
                                            </span> 
                        ...
                        <TabPanel>
                            <div>
                                <span className='flex flex-row gap-[5px]'> 
                                    <span>
                                        <Image src={mobile2} alt='img' width={25} height={25} />
                                    </span>
                                    <label className="text-[15px] text-white font-jakarta inline-block mb-[10px]">
                                        Phone Number
                                    </label>
                                </span>
                                <div className='flex'>
                                ...
                                <span className='flex flex-row gap-[5px]'> 
                                    <span>
                                        <Image src={password} alt='img' width={25} height={25} />
                                    </span>
                                    <label className="text-[15px] text-white font-jakarta inline-block mb-[10px]">
                                        Password
                                    </label>
                        ...
                        <TabPanel>
                            <div>
                                <span className='flex flex-row gap-[5px]'> 
                                    <span>
                                        <Image src={emailnumber} alt='img' width={25} height={25} />
                                    </span> 
                                    <label className="text-[15px] text-white font-jakarta inline-block mb-[10px]">
